...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi CursorLineNr  guifg=#f2f3bb guibg=#3f3f3f           ctermfg=229 ctermbg=237
    ...
    hi LineNr        guifg=#9fafaf guibg=#3f3f3f           ctermfg=248 ctermbg=237
    ...
    hi CursorLineNr  guifg=#d2d39b guibg=#3f3f3f           ctermfg=230 ctermbg=237
    if exists("g:zenburn_unified_CursorColumn") && g:zenburn_unified_CursorColumn
...
if exists("g:zenburn_transparent") && g:zenburn_transparent
    ...
    hi LineNr             ctermbg=NONE guibg=#3f3f3f
endif
